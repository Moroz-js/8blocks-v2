...
# Для RU-инстанса: медиа отдаёт EN-инстанс, поэтому в NEXT_PUBLIC_MEDIA_BASE_URL передаём его URL
NEXT_PUBLIC_MEDIA_BASE_URL="${NEXT_PUBLIC_MEDIA_BASE_URL:-}"SKIP_DATABASE_MAINTENANCE="${SKIP_DATABASE_MAINTENANCE:-false}"

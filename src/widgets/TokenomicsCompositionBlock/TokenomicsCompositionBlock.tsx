...
import { tokenomicsCompositionContent } from '@/shared/content/tokenomics'
...
export function TokenomicsCompositionBlock({
  ...
  return (
    <section className={styles.section} aria-label={tokenomicsCompositionContent.ariaLabel}>
      <div className={styles.inner}>
        ...
        <div className={styles.grid}>
          {tokenomicsCompositionContent.items.map((item, i) => (

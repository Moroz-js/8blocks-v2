...
import { tokenomicsProcessContent } from '@/shared/content/tokenomics'
...
const STEP_ICONS = [IconImmerse, IconBenchmark, IconTeam, IconRules, IconEcosystem, IconTokenFlow, IconSale, IconAdapt, IconFinalize]

const STEPS = tokenomicsProcessContent.steps.map((step, i) => ({
  ...step,
  Icon: STEP_ICONS[i],
  final: i === tokenomicsProcessContent.steps.length - 1,
}))
...
export function TokenomicsProcessWall({ headline }: TokenomicsProcessWallProps) {
  ...
  return (
    <section className={styles.section} aria-label={tokenomicsProcessContent.ariaLabel}>

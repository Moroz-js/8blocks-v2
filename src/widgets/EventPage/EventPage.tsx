    ...
    <section className={styles.root}>
      ...
      <div className={styles.main}>
        ...
        <div className={`${styles.metaGrid} ${past && event.format === 'online' ? styles.metaGridOnlinePast : ''}`}>
          ...
          {event.format === 'offline' && event.city && <a className={styles.infoSlot} href="#location"><MapPin size={22} /><span><strong>{event.venueName ?? eventCityLabel(event.city)}</strong><small>{eventCityLabel(event.city)}</small></span></a>}

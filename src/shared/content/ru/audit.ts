...
export const auditMeta = {
  ...
  ogTitle: 'Аудит токеномики | А8А9 токеномика.рф',
  ogDescription:
    'Полная оценка существующей токен-экономики: структурные риски и узкие места масштабирования.',
  twitterTitle: 'Аудит токеномики | А8А9 токеномика.рф',
  twitterDescription: 'Полная оценка существующей токен-экономики.',
} as const

export const auditContent = ruObject

export const auditZonesContent = {
  ariaLabel: 'Что мы проверяем',
  zones: [
    {

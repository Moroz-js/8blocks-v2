...
export const contactMeta = {
  title: 'Контакты',
  description:
    'Свяжитесь с А8А9 токеномика.рф: обсудим токен-экономику, консалтинг или аудит. Ответим в течение одного рабочего дня.',
  ogTitle: 'Контакты | А8А9 токеномика.рф',
...
export const contactPageContent = {
  hero: {
    ...
    description:
      'Пишите по вопросам стратегического консалтинга, токеномики и аудита. Ответим в течение одного рабочего дня.',
    person: {
      name: 'Оксана',
      role: 'COO',

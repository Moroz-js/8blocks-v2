...
export const strategicConsultingContent = ruObject

export const consultingMeta = {
  title: 'Стратегический консалтинг',
  description:
    'Помогаем Web3 и Web2 командам выстроить экономику проекта, подготовиться к инвестициям и пройти путь до выхода токена на рынок.',
  ogTitle: 'Стратегический консалтинг | А8А9 токеномика.рф',
  ogDescription:
    'Помогаем Web3 и Web2 командам выстроить экономику проекта, подготовиться к инвестициям и пройти путь до выхода токена на рынок.',
  twitterTitle: 'Стратегический консалтинг | А8А9 токеномика.рф',
  twitterDescription: 'Помогаем Web3 командам выстроить экономику проекта и подготовиться к TGE.',
} as const

export const consultingDeliverablesContent = {
  ariaLabel: 'Результаты консалтинга',
  items: [
    {
      title: 'Токеномика проекта',
      description: 'Разрабатываем полную модель: утилизацию токена, распределение, клейф, вестинг и эмиссию.',
...
export const consultingMapLabels = {
  nodes: [
    { id: 'business', lines: ['Бизнес-модель'] },
    { id: 'tokenomics', lines: ['Токеномика'] },
    { id: 'investment', lines: ['Инвестиционная', 'упаковка'] },
    { id: 'partners', lines: ['Партнерская', 'экосистема'] },
    { id: 'tge', lines: ['Подготовка', 'к TGE'] },
    { id: 'launch', lines: ['Запуск'] },
  ],
} as const
